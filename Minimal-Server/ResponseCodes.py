...
"""
Arquivo contendo todos os códigos de resposta do HTTP em formato JSON
Originalmente eu iria manter isso em um .json porém ter que ler um arquivo do disco 
    toda vez que for responder uma requisição não me parece muito eficiente
Logo, eu copiei o JSON todo e deixo ele armazenado dentro de uma variável do python, que estará em memória sempre
